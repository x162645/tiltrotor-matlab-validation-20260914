function results = run_xv15_80_from100(outputRoot)
...
c=struct('name','XV15_HELI_80.00KT_MULTISTART','V',100*knot2mps,'betaM',0,'gamma',0);
...
writetable(points,fullfile(outputRoot,'XV15_80_FROM100KT_CONTINUATION_POINTS.csv'));
writetable(multistart,fullfile(outputRoot,'XV15_80_FROM100KT_MULTISTART.csv'));
...
writetable(summary,fullfile(outputRoot,'XV15_80_FROM100KT_CONTINUATION_SUMMARY.csv'));
results=struct('contract',contract,'points',points,'multistart',multistart,'summary',summary,'reports',{reports});
save(fullfile(outputRoot,'XV15_80_FROM100KT_CONTINUATION_RESULTS.mat'),'results');
