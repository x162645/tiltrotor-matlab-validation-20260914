...
% Checks exact digitized cells and strict rejection of unsupported Mach gaps.
...
try
 gtrs_wing_airplane_source_coefficients(0,.3); error('test:ExpectedError','Mach gap was accepted.');
catch ME
 assert(strcmp(ME.identifier,'gtrs_wing_airplane_source_coefficients:MachGap'));
end
try
