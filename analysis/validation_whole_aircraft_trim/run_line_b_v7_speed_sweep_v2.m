function results=run_line_b_v7_speed_sweep_v2(outputRoot)
...
v1=load(fullfile(outputRoot,'V7_SWEEP_FROZEN.mat'),'P','hashes');
assert(isequaln(v1.P,P)&&isequaln(v1.hashes(2:end),hashes(2:end)), ...
 'run_line_b_v7_speed_sweep_v2:PhysicalMismatch','V2 must retain the exact V1 physical configuration and source files.');
...
crossPath=fullfile(outputRoot,'V2_SOLVER_CROSSCHECK_070kt.mat');
