function result=run_line_b_v7_trim_case(speedKt,outputRoot)
...
try
 ...
 totalRotorPower_kW=(L.torque+R.torque)*P.rotor.Omega/1000;
 row=table(speedKt,accepted,rn,z(1)/d2r,z(3),point.allocation.elevator/d2r,T,totalRotorPower_kW, ...
  ...
  'totalRotorPower_kW','thetaDifference_deg','stickDifference_in','elevatorDifference_deg','thrustDifference_pct','alphaClampCount'});
