function [alphaWing_deg,meta]=gtrs_wing_freefield_angle(alphaBody_deg,forceCoefficientSum,muMean)
%GTRS_WING_FREEFIELD_ANGLE Shared steady helicopter field input, not a fit.
% Ferguson CR166536 Sep1988 RevA, A70/PDF138 and B33/PDF383.
% CF is sum(norm(Frotor))/(rho*pi*Omega^2*R^4); NOT the doubled code CT.
% beta_m=0 -> X_RW=X_RW0. Same arithmetic formerly embedded in V3 tail.
...
delta=T.KXRW*T.XRW0*forceCoefficientSum/max(.15,muMean)^2*57.3;
