...
%D02_LAYOUT One explicit state/input/output contract for both model choices.
...
if ~ischar(mode)||~any(strcmp(mode,{'dynamic','quasisteady'}))
 error('d02:InvalidMode','Expected dynamic or quasisteady.');
end
