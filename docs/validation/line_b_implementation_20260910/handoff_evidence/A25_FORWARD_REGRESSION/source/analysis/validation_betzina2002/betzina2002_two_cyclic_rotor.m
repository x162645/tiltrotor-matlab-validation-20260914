function out = betzina2002_two_cyclic_rotor(P,muTotal,alphaDeg,theta75Deg,cyclicLongDeg,cyclicLatDeg)
...
if numel(zFlap) ~= 3
    error('betzina2002_two_cyclic_rotor:InvalidFlapInitial','Expected 3 flap harmonics.');
end
...
out=struct();
out.modelId='M1_EVIDENCE_V1_FORWARD_PROPAGATION_TWO_CYCLIC_DIAGNOSTIC';
