function [zBest,eBest,repBest] = solve_betzina_v4_regression(P,mu,alphaDeg,targetCT,seed)
...
try, e=betzina_v4_regression_adapter(P,mu,a,z(1),z(2),z(3)); e.solutionValid=false;
