...
CSV 必须使用 SI 单位，并至少包含：`time_s`, `collective_actual_rad`, `nacelle_left_rad`, `nacelle_right_rad`, `rotor_speed_left_rad_s`, `rotor_speed_right_rad_s`, `rotor_thrust_left_N`, `rotor_thrust_right_N`, `u_m_s`, `v_m_s`, `w_m_s`, `p_rad_s`, `q_rad_s`, `r_rad_s`, `phi_rad`, `theta_rad`, `psi_rad`, `altitude_m`。
